...
/**
 * Junta vários Float32Array (chunks PCM) num único array contíguo.
 */
...
/**
 * Codifica um AudioBuffer mono em um WAV (PCM 16-bit) para download.
 * Self-contained (sem libs externas), respeitando o sampleRate do buffer.
 */
