...
export const FONT_OPTIONS: { id: string; name: string; desc: string; stack: string }[] = [
  { id: 'gemini',  name: 'Gemini',       desc: 'Google Sans · padrão',          stack: "'Google Sans', sans-serif" },
  { id: 'claude',  name: 'Claude',       desc: 'Serifada editorial (inspirada)', stack: "'Source Serif 4', Georgia, serif" },
  { id: 'chatgpt', name: 'ChatGPT',      desc: 'Inter, estilo Söhne (inspirada)', stack: "'Inter', system-ui, sans-serif" },
  { id: 'roboto',  name: 'Roboto',       desc: 'Clássica do Android',           stack: "'Roboto', sans-serif" },
  { id: 'arial',   name: 'Arial',        desc: 'Clássica do sistema',           stack: "Arial, Helvetica, sans-serif" },
  { id: 'system',  name: 'Sistema',      desc: 'Fonte nativa do SO',            stack: "system-ui, -apple-system, 'Segoe UI', sans-serif" },
  { id: 'serif',   name: 'Serifada',     desc: 'Georgia / Times',               stack: "Georgia, 'Times New Roman', serif" },
  { id: 'mono',    name: 'Monoespaçada', desc: 'Estilo terminal',               stack: "ui-monospace, 'Consolas', monospace" },
];
...
export const MODEL_OPTIONS = [
  ...
  { id: LOCAL_MODEL_ID, name: 'Modelo Local', desc: 'Seu modelo rodando em llama.cpp e exposto via ngrok (API compatível com OpenAI)', hasSearch: false }
];
