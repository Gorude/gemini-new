...
function extractAndParseJson(text) {
  try {
    ...
    try {
      ...
      console.log("After escapeInnerQuotes:", fixedJson);

      fixedJson = fixedJson.replace(/\\"\s*(,|\}|\]|$)/g, '"$1');
      console.log("After fixing escaped closing quotes:", fixedJson);
      ...
      console.log("After doubling backslashes:", fixedJson);

      fixedJson = fixedJson.replace(/,\s*([\]}])/g, '$1');
      console.log("After removing trailing commas:", fixedJson);
